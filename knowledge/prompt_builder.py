...
def build_visualization_prompt(gui_mode: bool = False) -> str:
    ...
    lines = [
        ...
        "- `manage_plot` — structural ops (reset, zoom, export, add/remove traces)",
        ...
        "- `panel_types` (array): per-panel type parallel to panels, e.g. [\"spectrogram\",\"line\"]",
        ...
        "- `log_z` (boolean): log scale on color axis (spectrogram intensity)",
        ...
        "  \"colorscale\": \"Jet\", \"log_z\": true",
        "})",
        "```",
        "",
        "## Using manage_plot",
        "",
        "For structural operations that aren't spec-driven:",
        ...
        "3. Do NOT call manage_plot(action=\"export\") — exporting is handled by the orchestrator",
        "",
