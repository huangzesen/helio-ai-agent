...
def build_visualization_prompt(gui_mode: bool = False) -> str:
    ...
    lines = [
        ...
        "- `review.warnings`: potential issues detected (cluttered panels, resolution mismatches, suspicious values, invisible traces)",
        ...
        "- Invisible traces / empty panel (all NaN): inform the user that the data has no plottable values for the affected parameters and suggest trying a different time range or dataset.",
        "",
