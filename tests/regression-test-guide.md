...
| `has <tool>` | Tool was called (e.g., `delegate_to_mission`) |
      ...
      "turns": [
        {
          ...
          "response": {
            "text": "I've fetched...",
            "error": null,
            "tool_calls": ["delegate_to_mission"],
            "elapsed": 12.3
          },
          "checks": [
            {"label": "has delegate_to_mission", "passed": true, "detail": ""},
            ...
          ]
        }
      ]
