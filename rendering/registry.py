...
METHODS = [
    ...
    },
    {
        ...
        "description": "Plot a spectrogram (2D heatmap) from a computed spectrogram dataset. Use for frequency-time or energy-time spectrograms.",
        "parameters": [
            {"name": "label", "type": "string", "required": True,
             "description": "Label of the spectrogram data in memory"},
            {"name": "title", "type": "string", "required": False, "default": "",
             "description": "Optional plot title"},
            {"name": "colorscale", "type": "string", "required": False, "default": "Viridis",
             "description": "Plotly colorscale name (e.g., Viridis, Jet, Plasma, Inferno)"},
            {"name": "log_y", "type": "boolean", "required": False, "default": False,
             "description": "Log scale on y-axis (frequency/energy)"},
            {"name": "log_z", "type": "boolean", "required": False, "default": False,
             "description": "Log scale on color axis (intensity)"},
            {"name": "z_min", "type": "number", "required": False,
             "description": "Min value for color scale"},
            {"name": "z_max", "type": "number", "required": False,
             "description": "Max value for color scale"},
            {"name": "index", "type": "integer", "required": False, "default": -1,
             "description": "Panel index (0-based). -1 for default."},
        ],
    },
    {
        "name": "reset",
