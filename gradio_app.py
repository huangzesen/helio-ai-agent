...
EXAMPLES = [
    ...
    {"text": "Show me electron pitch angle distribution along with Br and |B| and radial solar wind speed for a recent Parker Solar Probe perihelion, +/- 3 days from the perihelion date."},
    {"text": "Compare ACE and Wind magnetic field and solar wind proton density during the September 2017 solar storm. Show all four quantities in a multi-panel plot with a vertical marker at the shock arrival."},
    {"text": "Show me MMS burst-mode ion energy spectrogram, electron energy spectrogram, and magnetic field components around a magnetopause crossing on 2024-01-02. Use a 2-hour window centered on 06:00 UTC."},
]
